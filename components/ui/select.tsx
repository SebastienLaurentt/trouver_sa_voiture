...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between text-slate-950 whitespace-nowrap rounded-md border border-input bg-secondary px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-slate-950 focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
