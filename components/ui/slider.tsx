...
>(
  (
    { className, value, defaultValue, onValueChange, unit = "", ...props },
    ref
  ) => {
      ...
      >
        ...
        {internalValues.map((value, index) => (
          <React.Fragment key={index}>
            <SliderPrimitive.Thumb className="block size-4 rounded-full border border-white/50 bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
            <div
