...
export default function LoginPage() {
  return (
    <div className="flex h-screen flex-col-reverse items-center justify-center text-white md:flex-col xl:mx-16 xl:flex-row xl:gap-x-8 2xl:mx-auto 2xl:max-w-[1600px]">
